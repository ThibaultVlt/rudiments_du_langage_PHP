...
<!DOCTYPE html>
    ...
    <body>
        <h1>Identifiez-vous</h1>
            ...
            $msg qui affichera « Saisie obligatoire » lors de la première publication de la page. -->
...
// Vérifier que tout les champs du formulaire sont remplis, sinon $msg qui affichera « Saisie obligatoire »
    if (!isset($_POST["valider"])){
        ...
        if(empty($_POST["email"])){
            $msg = "Saisie obligatoire de l'email";
            $erreur = true;
        }

        if(empty($_POST["password"])){
            $msg = "Saisie obligatoire du mot de passe";
            $erreur = true;
        }
